...
namespace DevLunch.Tests.Controllers
{
    ...
    public class LunchesControllerTests
    {
        ...
        public void Downvote_PostWithSameUserDifferentRestaurant_RecalculatesTotalsForEachRestaurant()
        {
            ...
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId1, 1);
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId2, 0);
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId3, -2);
        }
        ...
        public void Downvote_PostWithSameUserDifferentRestaurant_DownvoteOriginallyUpvotedRestaurant()
        {
            ...
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId1, -2);
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId2, 0);
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId3, -2);
        }
        ...
        public void Downvote_PostWithSameUserDifferentRestaurant_DownvoteOriginallyUpvotedRestaurantThenUpvoteThenDownvoteAgain()
        {
            ...
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId1, -2);
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId2, 1);
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId3, 1);
        }
        ...
        public void Vote_PostWithDifferntUser_CheckTotalVoteValue()
        {
            ...
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId1, 2);
            AssertLunchRestaurantVoteTotal(lunchId, restaurantId3, -4);
        }
